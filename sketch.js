      ...
      //  fiz uma nova fase pro jogo do Alfredo-o-Coelho kkkkk
...
function setup() 
{
  ...
  e1 = createSprite(220,120, 20, 20);
  e1.addImage(eImg);
  e1.scale = 0.02;

  e2 = createSprite(195, 510, 20, 20);
  e2.addImage(eImg);
  e2.scale = 0.02;
  ...
  ar2 = createImg("balloon.png");
  ar2.position(30, 450);
  ar2.size(120, 120);
  ar2.mouseClicked(Ar2);

  //ar3 = createImg("balloon2.png");
  //ar3.position(460, 240);
  //ar3.size(120, 120);
  //ar3.mouseClicked(Ar3);
  ...
  button.position(180,290);
  button.size(50,50);
  button.mouseClicked(drop);

  //botão 2
  button2 = createImg('cut_btn.png');
  button2.position(340,90);
  button2.size(50,50);
  button2.mouseClicked(drop2);

  cc = createSprite(485,570,85,15);

  rope = new Rope(6,{x:185,y:300});
  ...
  bunny = createSprite(480,500,100,100);
  bunny.scale = 0.2;
